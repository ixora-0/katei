  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "hard-inset": "0.25rem 0.25rem 1px var(--shadow-color), inset 0.1rem 0.1rem 1px 1px var(--shadow-color)",
        "hard-md-inset-sm": "0.5rem 0.5rem 1px var(--shadow-color), inset 0.05rem 0.05rem 1px 1px var(--shadow-color)",
        "hard-lg-inset-md": "1rem 1rem 1px 1px var(--shadow-color), inset 0.2rem 0.2rem 2px 2px var(--shadow-color)",
        "hard-xl-inset": "2rem 2rem 2px 2px var(--shadow-color), inset 0.1rem 0.1rem 1px 1px var(--shadow-color)"
      },
      dropShadow: {
