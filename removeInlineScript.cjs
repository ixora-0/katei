// Script detection doesn't work in current versions of SvelteKit
// using workaround from:
// https://github.com/antony/sveltekit-adapter-browser-extension/issues/24#issuecomment-1714652077
